...
#if defined STM32F303xE || defined STM32F302x8  || defined STM32F072CBTx
...
* Return         : None.
*******************************************************************************/
#define BTABLE_ADDR(bEpNum) ((volatile uint16_t *) ((((uint16_t) *BTABLE) \
    + bEpNum * 8) + PMAAddr))
...
* Return         : None.
*******************************************************************************/
#define BTABLE_ADDR_FROM_OFFSET(bEpNum, wOffset) ((volatile uint16_t *) \
    ((wOffset + bEpNum * 8) + PMAAddr))
